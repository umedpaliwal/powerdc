...
export default function ReDashboardFilters({
  ...
  const getUniqueValues = (field: string) => {
    ...
    if (filters.normalized_owner && field !== "normalized_owner") {
      filteredPlants = filteredPlants.filter(
        (plant) => plant.normalized_owner === filters.normalized_owner
      );
    }
  ...
  return (
    <Box>
      ...
      <TextField
        ...
        value={filters.normalized_owner || ""}
        onChange={handleFilterChange}
        fullWidth
        margin="normal"
        variant="outlined"
      ...
      >
        ...
        {getUniqueValues("normalized_owner").map((normalized_owner) => (
          <option key={normalized_owner} value={normalized_owner}>
            {normalized_owner}
          </option>
        ))}
      </TextField>
